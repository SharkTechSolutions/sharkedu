...
export default function CheckoutForm({ courses, initialCourseSlug, studentEmail, studentName }) {
  ...
  return (
    <form className="checkout-form" onSubmit={handlePayment} noValidate>
      ...
      <button type="submit" className="btn full-width btn-lg" disabled={processing}>
        {processing
          ? "Processing…"
